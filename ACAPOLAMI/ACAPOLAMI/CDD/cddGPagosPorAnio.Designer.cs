...
WHERE (YEAR(c.fechaPago) = YEAR(@fechaPago))";
        ...
        public virtual int Fill(cddGPagosPorAnio.DataTable1DataTable dataTable, System.DateTime fechaPago) {
        ...
        public virtual cddGPagosPorAnio.DataTable1DataTable GetData(System.DateTime fechaPago) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((System.DateTime)(fechaPago));
            cddGPagosPorAnio.DataTable1DataTable dataTable = new cddGPagosPorAnio.DataTable1DataTable();
